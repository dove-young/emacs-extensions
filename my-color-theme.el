...
;     (( background-color . "black")
     ...
     (default ((t (:stipple nil :background "#102C29" :foreground "wheat" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 173 :width normal :foundry "Misc" :family "Fixed"))))
     ...
     (compilation-column-number ((t (:bold t :weight bold :foreground "YellowGreen"))))
     (compilation-error ((t (:bold t :weight bold :foreground "red"))))
     (compilation-info ((t (:bold t :foreground "Green1" :weight bold))))
     (compilation-line-number ((t (:bold t :weight bold :foreground "Aquamarine"))))
     (compilation-warning ((t (:bold t :foreground "Orange" :weight bold))))
     (completions-common-part ((t (:family "Fixed" :foundry "Misc" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "wheat" :background "#102C29" :stipple nil :height 173))))
     ...
     (custom-face-tag ((t (:bold t :weight bold :foreground "Aquamarine"))))
     (custom-group-tag ((t (:bold t :family "Sans Serif" :foreground "MediumAquamarine" :weight bold :height 1.2))))
...
;     (eshell-prompt-face ((t (:foreground "powder blue"))))
     ...
     (org-agenda-clocking ((t (:foreground "SlateBlue" :background "Aquamarine"))))
     (org-agenda-column-dateline ((t (:family "Fixed" :weight normal :slant normal :underline nil :strike-through nil :background "grey30" :height 173))))
     ...
     (org-agenda-diary ((t (:family "Fixed" :foundry "Misc" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "wheat" :background "#102C29" :stipple nil :height 173))))
     ...
     (org-level-2 ((t (:bold t :foreground "Aquamarine" :weight bold))))
     (org-level-3 ((t (:foreground "Salmon"))))
     (org-level-4 ((t (:foreground "LightBlue"))))
     (org-level-5 ((t (:bold t :foreground "YellowGreen" :weight bold))))
     (org-level-6 ((t (:foreground "Aquamarine"))))
     (org-level-7 ((t (:bold t :foreground "PaleGreen" :weight bold))))
     ...
     (outline-4 ((t (:foreground "LightBlue"))))
     (outline-5 ((t (:bold t :weight bold :foreground "YellowGreen"))))
     (outline-6 ((t (:foreground "Aquamarine"))))
     (outline-7 ((t (:bold t :weight bold :foreground "PaleGreen"))))
     ...
     (w3m-form-button-face ((t (:background "lightgrey" :foreground "black" :box (:line-width 2 :style released-button)))))
...
; This is my color theme. I just made a minor change.
